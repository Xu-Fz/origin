...
import com.fzbox.component.db.dao.StandardConverter;
...
final public class SQLiteStandardConverter extends StandardConverter {
	...
	final public String getSubsectionQuerySQL(String sql, int startRow,
			int rowNum) {
		StringBuffer buffer = new StringBuffer();
		buffer.append(sql).append(" limit ").append(startRow).append(",")
				.append(startRow + rowNum);
